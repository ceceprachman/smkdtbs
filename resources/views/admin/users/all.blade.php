          ...
          <td>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{route('admin.edit', ['id' => $users[$i]->id])}}"><i class="glyphicon glyphicon-pencil"></i> Edit</a></li>
                    <li>
                        <a href="{{route('admin.destroy', ['id' => $users[$i]->id])}}"><i class="glyphicon glyphicon-trash"></i> Delete</a>
                    </li>
                    <li><a href="{{route('admin.show', ['id' => $users[$i]->id])}}"><i class="glyphicon glyphicon-search"></i> Details</a></li>
                </ul>
            </div>
          </td>
        </tr>
